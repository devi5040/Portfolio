    ...
    >
      <div className="md:w-[1120px] flex flex-col-reverse md:grid md:grid-cols-2">
        <div className="font-poppins flex flex-col text-white justify-center p-6 space-y-10">
          <h1 className="text-2xl text-center md:text-6xl border-l-4 border-font font-bold uppercase ">
            &nbsp;Deviprasad &nbsp;Rai P
          </h1>
          <h3 className="text-xl text-center md:text-4xl font-semibold">Full Stack Web Developer</h3>
        </div>
